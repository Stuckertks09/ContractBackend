...
const OfferSchema = new mongoose.Schema({
  ...
  bindingAcceptanceDate: { type: Date },
  ...
  stage: { type: String, enum: ['Created', 'Drafting', 'Submitted', 'Under Review', 'Signatures', 'Sent to Agent', 'Countered', 'Accepted', 'Rejected'], default: 'Created' },
  state: { type: String },
